...
export class NotificationsController {
  ...
  myNotifications(
    ...
    return this.notificationsService.listForUser(user.userId, user.role, limit ? Number(limit) : undefined);
  }

  @Get('notifications/me/unread-count')
  myUnreadCount(@CurrentUser() user: { userId: bigint; role: 'admin' | 'user' }) {
  ...
  markAsRead(
    ...
    return this.notificationsService.markAsRead(Number(id), user.userId, user.role);
  }
  ...
  adminList(
    ...
    return this.notificationsService.adminList({ page, pageSize, search, targetRole, isPublished });
  }
